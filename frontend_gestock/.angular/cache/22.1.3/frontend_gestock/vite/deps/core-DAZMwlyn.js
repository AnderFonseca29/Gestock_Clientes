...
function getBaseDocUrl() {
	const full = VERSION.full;
	return `https://${full.includes("-next") || full.includes("-rc") || full === "22.1.1" ? "next" : `v${VERSION.major}`}.angular.dev`;
}
